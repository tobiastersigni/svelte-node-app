    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section0, file$3, 124, 8, 4166);
    			attr_dev(button0, "class", "button is-link is-small");
    			add_location(button0, file$3, 127, 16, 4281);
    			attr_dev(button1, "class", "button is-text is-small");
    			add_location(button1, file$3, 130, 16, 4413);
    			attr_dev(div0, "class", "buttons");
    			add_location(div0, file$3, 126, 12, 4243);
    			add_location(section1, file$3, 125, 8, 4221);
    			attr_dev(div1, "class", "columns");
    			add_location(div1, file$3, 140, 12, 4776);
    			attr_dev(section2, "class", "mt-2");
    			add_location(section2, file$3, 139, 8, 4741);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(icon.$$.fragment);
    			attr_dev(div, "class", "section");
    			add_location(div, file$3, 120, 8, 4058);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(icon, div, null);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label, "class", "label");
    			add_location(label, file$3, 144, 28, 4967);
    			attr_dev(textarea, "id", "menuDetails");
    			attr_dev(textarea, "class", "textarea");
    			attr_dev(textarea, "rows", "10");
    			add_location(textarea, file$3, 152, 32, 5367);
    			attr_dev(div0, "class", "control");
    			add_location(div0, file$3, 151, 28, 5313);
    			attr_dev(div1, "class", "field");
    			add_location(div1, file$3, 143, 24, 4919);
    			attr_dev(div2, "class", "column");
    			add_location(div2, file$3, 142, 20, 4874);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block.c();
    			attr_dev(a0, "href", "/");
    			add_location(a0, file$3, 109, 16, 3752);
    			add_location(li0, file$3, 108, 12, 3731);
    			attr_dev(a1, "href", "/admin/manage-menus");
    			add_location(a1, file$3, 112, 16, 3824);
    			add_location(li1, file$3, 111, 12, 3803);
    			attr_dev(a2, "href", "/#");
    			add_location(a2, file$3, 115, 16, 3953);
    			attr_dev(li2, "class", "is-active");
    			add_location(li2, file$3, 114, 12, 3914);
    			add_location(ul, file$3, 107, 8, 3714);
    			attr_dev(nav, "class", "breadcrumb");
    			attr_dev(nav, "aria-label", "breadcrumbs");
    			add_location(nav, file$3, 106, 4, 3656);
    			add_location(div, file$3, 105, 0, 3646);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    	...
    	async function save() {
    		...
    		for (let i = 0; i < lunchWeek.lunchDays.length; i++) {
    			...
    			if (lunchDay.lunchDayId) {
    				await secureAxios.put(`${"http://localhost:3000"}/api/lunch-weeks/${routeLunchWeekId}/lunch-day/${lunchDay.lunchDayId}`, lunchDay);
    			} else {
    				const response = await secureAxios.post(`${"http://localhost:3000"}/api/lunch-weeks/${routeLunchWeekId}/lunch-day`, lunchDay); // otherwise do a POST and assign the resulting ID
