    ...
    const register = async () => {
        ...
        try {
            ...
            registrationSuccessMessage =
                "Thank you for registering, redirecting to login...";
    ...
    <div class="columns">
        <div class="column">
            <div class="content">
                ...
                <p>
                    We make it easy to publish weekly school lunch menus on the
                    web and provide them to students and parents in a mobile
                    friendly format.
                </p>
                <p>
                    Just set the details and hit publish! Register and get
                    started today.
                </p>
            </div>
        </div>
